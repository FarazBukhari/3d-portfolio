...
const Island = ({ isRotating, setIsRotating, setCurrentStage, ...props }) => {
    ...
    useFrame(() => {
        if (!isRotating) {
             ...
             * prevent potentail issues with very large or negative rotation values.
             * Here's a step-by-step explanation of what this code does:
             *  1.  rotation % (2 * Math.PI) calculates the remainder of the rotation value when divided
             *      by 2 * Math.PI. This essentially wraps the rotation valu around once it reaches a
             *      full circle (360 degrees) sp that it stays within the range of 0 to 2 * Math.PI.
             *  2.  (rotation % (2 * Math.PI)) + 2 * Math.PI adds 2 * Math.Pi to the result from step 1.
             *      This is done to ensure that the value remains positive and within the range of
             *      0 to 2 * Math.PI even if it was a negative after the modulo operation in step 1.
